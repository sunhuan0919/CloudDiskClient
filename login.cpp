...
#if 0
    // 测试数据
    ui->reg_usr->setText("sun");
    ui->reg_nickname->setText("sun");
    ui->reg_pwd->setText("980919");
    ui->reg_surepwd->setText("980919");
    ui->reg_phone->setText("18811022606");
    ui->reg_mail->setText("2060207050@qq.com");
...
void Login::on_login_btn_clicked()
{
    ...
    connect(reply, &QNetworkReply::finished, [=]()
    {
        ...
        */
        ...
        QStringList tmpList = getLoginStatus(json); //common.h，返回code+token的stringlist
        if( tmpList.at(0) == "000" )
        {
            cout << "登陆成功";
            ...
            this->hide();
            // 主界面窗口显示
            m_mainWin->showMainWindow(p->getUser());
        }
        else
        {
